...
$(document).ready(function () {
    ...
    $(document).on("keyup change", ".JISVII_AmendQty", function () {
        ...
        console.log("Prev Invoice Qty:", prevInvoiceQty);
...
function DateBind() {
    ...
    $("#Header_JISVIH_InvoiceDate").val(formattedDate);
...
<tr class="NewRow"
    ...
    <td>
        <select name="Items[${rowCount}].JISVII_JISVOH_Number"
                class="form-select JISVII_JISVOH_Number"></select>
    </td>
