...
namespace ERP_DTO
{
    public class SOToSaleInvoice_DTO
    {
    ...
    public class SOToSaleInvoiceHead_DTO
    {
        ...
        public List<SOToSaleInvoiceItem_DTO>? InvoiceItem { get; set; }
        public List<SOToSaleInvoiceIncome_DTO>? Income { get; set; }
        public List<SOToSaleInvoiceIIncome_DTO>? ItemIncome { get; set; }
        public List<SOToSaleInvoiceBatch_DTO>? ItemBatch { get; set; }
        public List<SOToSaleInvoiceAddress_DTO>? BuyerAddress { get; set; }
    ...
    public class SOToSaleInvoiceItem_DTO
    {
    ...
    public class SOToSaleInvoiceIncome_DTO
    {
    ...
    public class SOToSaleInvoiceIIncome_DTO
    {
    ...
    public class SOToSaleInvoiceBatch_DTO
    {
    ...
    public class SOToSaleInvoiceAddress_DTO
    {
    ...
    public class SOToSaleInvoiceGst
    {
    ...
    public class SOToSaleInvoiceWHT
    {
    ...
    public class SOToSI_DTO
    {
        public List<SaleOrderSIItem_DTO>? SOItems { get; set; }
        public List<SaleOrderSIIncome_DTO>? SOIncomes { get; set; }
        public List<SaleOrderSIIIncome_DTO>? SOItemIncomes { get; set; }
    }
    public class SaleOrderSIItem_DTO
    {
    ...
    public class SaleOrderSIIncome_DTO
    {
    ...
    public class SaleOrderSIIIncome_DTO
    {
    ...
    public class SOToSaleInvoiceAddress
    {
