...
namespace ERP_DTO
{
    public class SIItemToSaleRejection_DTO
    {
        ...
        public Int64 SR_Bill_BUY_ADD_Number { get; set; }
        public Int64 SR_Ship_BUY_ADD_Number { get; set; }
    ...
    public class SIItemToSaleRejectionHead_DTO
    {
        ...
        public List<SIItemToSaleRejectionItem_DTO>? RejectionItem { get; set; }
        public List<SIItemToSaleRejectionIncome_DTO>? Income { get; set; }
        public List<SIItemToSaleRejectionIIncome_DTO>? ItemIncome { get; set; }
        public List<SIItemToSaleRejectionBatch_DTO>? ItemBatch { get; set; }
        public List<SIItemToSaleRejectionAddress_DTO>? BuyerAddress { get; set; }
    ...
    public class SIItemToSaleRejectionItem_DTO
    {
    ...
    public class SIItemToSaleRejectionIncome_DTO
    {
    ...
    public class SIItemToSaleRejectionIIncome_DTO
    {
    ...
    public class SIItemToSaleRejectionBatch_DTO
    {
    ...
    public class SIItemToSaleRejectionAddress_DTO
    {
    ...
    public class SIItemToSaleRejectionGst
    {
    ...
    public class SIItemToSaleRejectionWHT
    {
    ...
    public class SIItemToSR_DTO
    {
        public List<SRItemSaleInvoiceItem_DTO>? SIItems { get; set; }
        public List<SRItemSaleInvoiceIncome_DTO>? SIIncomes { get; set; }
        public List<SRItemSaleInvoiceIIncome_DTO>? SIItemIncomes { get; set; }
    }
    public class SRItemSaleInvoiceItem_DTO
    {
    ...
    public class SRItemSaleInvoiceIncome_DTO
    {
    ...
    public class SRItemSaleInvoiceIIncome_DTO
    {
