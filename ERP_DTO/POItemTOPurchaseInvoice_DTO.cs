...
namespace ERP_DTO
{
    public class POItemTOPurchaseInvoice_DTO
    {
    ...
    public class POItemTOPurchaseInvoiceHead_DTO
    {
        public Int64 PIH_Number { get; set; }
        ...
        public List<POItemTOPurchaseInvoiceItem_DTO>? InvoiceItems { get; set; }
        public List<POItemTOPurchaseInvoiceExpense_DTO>? Expenses { get; set; }
        public List<POItemTOPurchaseInvoiceIExpense_DTO>? ItemExpenses { get; set; }
        public List<POItemTOPurchaseInvoiceBatch_DTO>? ItemBatch { get; set; }
        public void Reset()
        {
            this.PIH_Number = 0;
    ...
    public class POItemTOPurchaseInvoiceItem_DTO
    {
        public Int64 PII_Number { get; set; }
        ...
        public Int64 PII_POH_Number { get; set; }
        public Int64 PII_POI_Number { get; set; }
        public String? PII_PO_Date { get; set; }
        ...
        public void Reset()
        {
            ...
            this.PII_WHT_Percent = "";
            this.PII_WHT_Amount = "";
            this.PII_IsDeleted = "false";
        }
    }

    public class POItemTOPurchaseInvoiceExpense_DTO
    {
    ...
    public class POItemTOPurchaseInvoiceIExpense_DTO
    {
    ...
    public class POItemTOPurchaseInvoiceBatch_DTO
    {
        public Int64 PII_BCH_Number { get; set; }
    ...
    public class POItemTOPurchaseInvoiceGst
    {
    ...
    public class POItemTOPurchaseInvoiceWHT
    {
    ...
    public class POItemTOPurchaseInvoiceAscii
    {
        public Int64 PIH_Number { get; set; }
    ...
    public class POItemTOPurchaseInvoiceDetailAscii
    {
        public Int64 PIH_Number { get; set; }
    ...
    public class POItemTOPI_DTO
    {
        public List<PurchaseOrderPIHItem_DTO>? POItems { get; set; }
        public List<PurchaseOrderPIHExpense_DTO>? POExpenses { get; set; }
        public List<PurchaseOrderPIHIExpense_DTO>? POItemExpenses { get; set; }
    }
    public class PurchaseOrderPIHItem_DTO
    {
        public Int64 POI_Number { get; set; }
        public Int64 POH_Number { get; set; }
        public String? POH_OrderNo { get; set; }
        public String? POH_PODate { get; set; }
    ...
    public class PurchaseOrderPIHExpense_DTO
    {
    ...
    public class PurchaseOrderPIHIExpense_DTO
    {
