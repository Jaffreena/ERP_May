...
namespace ERP_DTO
{
    public class GRNItemToPurchaseReturn_DTO
    {
    ...
    public class GRNItemToPurchaseReturnHead_DTO
    {
        public Int64 PRH_Number { get; set; }
        ...
        public List<GRNItemToPurchaseReturnItem_DTO>? ReturnItems { get; set; }
        public List<GRNItemToPurchaseReturnExpense_DTO>? Expenses { get; set; }
        public List<GRNItemToPurchaseReturnIExpense_DTO>? ItemExpenses { get; set; }
        public List<GRNItemToPurchaseReturnBatch_DTO>? ItemBatch { get; set; }
        public void Reset()
        {
            this.PRH_Number = 0;
            this.PRH_ReturnNo = null;
    ...
    public class GRNItemToPurchaseReturnItem_DTO
    {
        public Int64 PRI_Number { get; set; }
        public Int64 PRI_Index { get; set; }
        public Int64 PRI_PII_Number { get; set; }
    ...
    public class GRNItemToPurchaseReturnExpense_DTO
    {
    ...
    public class GRNItemToPurchaseReturnIExpense_DTO
    {
    ...
    public class GRNItemToPurchaseReturnBatch_DTO
    {
    ...
    public class GRNItemToPurchaseReturnGst
    {
    ...
    public class GRNItemToPurchaseReturnWHT
    {
    ...
    public class GRNItemToPurchaseReturnAscii
    {
        public Int64 PRH_Number { get; set; }
    ...
    public class GRNItemToPurchaseReturnDetailAscii
    {
        public Int64 PRH_Number { get; set; }
    ...
    public class PIToItemPR_DTO
    {
        public List<PurchaseInvoiceItemPRItem_DTO>? PRItems { get; set; }
        public List<PurchaseInvoiceItemPRExpense_DTO>? PRExpenses { get; set; }
        public List<PurchaseInvoiceItemPRIExpense_DTO>? PRItemExpenses { get; set; }
    }
    public class PurchaseInvoiceItemPRItem_DTO
    {
    ...
    public class PurchaseInvoiceItemPRExpense_DTO
    {
    ...
    public class PurchaseInvoiceItemPRIExpense_DTO
    {
