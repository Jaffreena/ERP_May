...
namespace ERP_DTO
{
    public class PurchaseInvoice_DTO
    {
        public Int64 PIH_Number { get; set; }
        public String? PIH_POH_OrderNo { get; set; }
        public String? PIH_POH_Date { get; set; }
        public Int32 PIH_POH_OrderCount { get; set; }
        ...
        public String? PIH_Vendor_Category { get; set; }
        public String? PIH_Vendor_Group { get; set; }
        public String? PIH_Vendor_Name { get; set; }
        ...
        public String? PIH_Amount { get; set; }
        ...
        public String? PII_Item_MaterialGrade { get; set; }
        public String? PII_Item_Thickness { get; set; }
        public String? PII_Item_Width { get; set; }
        ...
        public String? PII_HSN_Description { get; set; }
    ...
    public class PurchaseInvoiceHead_DTO
    {
        public Int64 PIH_Number { get; set; }
        ...
        public List<PurchaseInvoiceItem_DTO>? InvoiceItems { get; set; }
        public List<PurchaseInvoiceExpense_DTO>? Expenses { get; set; }
        public List<PurchaseInvoiceIExpense_DTO>? ItemExpenses { get; set; }
        public List<PurchaseInvoiceBatch_DTO>? ItemBatch { get; set; }
    ...
    public class PurchaseInvoiceItem_DTO
    {
        public Int64 PII_Number { get; set; }
        ...
        public String? PII_Thickness { get; set; }

        [Display(Name = "Width")]
        public String? PII_Width { get; set; }

        [Display(Name = "Material Grade")]
        public String? PII_MaterialGrade { get; set; }
    ...
    public class PurchaseInvoiceExpense_DTO
    {
    ...
    public class PurchaseInvoiceIExpense_DTO
    {
        public Int64 PII_EXP_Number { get; set; }
        public Int64 PII_EXP_PII_Number { get; set; }
        public String? PII_EXP_Item_Number { get; set; }
        public Int64 PII_EXP_Item_Index { get; set; }
        ...
        public void Reset()
        {
            ...
            this.PII_EXP_Item_Number = "";
            this.PII_EXP_Item_Index = 0;
            ...
            this.PII_EXP_IsDeleted = "";
        }
    }
    public class PurchaseInvoiceBatch_DTO
    {
        public Int64 PII_BCH_Number { get; set; }
        public Int64 PII_BCH_PII_Number { get; set; }
        public Int64 PII_BCH_Item_Index { get; set; }
        public String? PII_BCH_Item_Number { get; set; }
    ...
    public class PurchaseInvoiceGst
    {
    ...
    public class PurchaseInvoiceWHT
    {
    ...
    public class PurchaseInvoiceAscii
    {
        public Int64 PIH_Number { get; set; }
    ...
    public class PurchaseInvoiceDetailAscii
    {
        public Int64 PIH_Number { get; set; }
