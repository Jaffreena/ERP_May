...
namespace ERP_DTO
{
    ...
    public class SaleInvoiceRegister_DTO
    {
        public Int64 SI_Number { get; set; }
        public String? SI_InvoiceNo { get; set; }
        public String? SI_InvoiceDate { get; set; }
        public String? SI_SOH_OrderNo { get; set; }
        public String? SI_SOH_OrderDate { get; set; }
        public Int32 SI_SOH_OrderCount { get; set; }
        public String? SI_ExportOrder { get; set; }
        public String? SI_BYC_Category { get; set; }
        public String? SI_BYG_Group { get; set; }
        public String? SI_BUY_Name { get; set; }
        public String? SI_MS_Name { get; set; }
        public String? SI_ITM_Group { get; set; }
        public String? SI_ITM_Code { get; set; }
        public String? SI_ITM_Description { get; set; }
        public String? SI_ITM_OuterDia { get; set; }
        public String? SI_ITM_Thickness { get; set; }
        public String? SI_ITM_Length { get; set; }
        public String? SI_ITM_MaterialGrade { get; set; }
        public String? SI_WH_Name { get; set; }
        public String? SI_Qty { get; set; }
        public String? SI_UoM_Name { get; set; }
        public String? SI_NoOfItem { get; set; }
        public String? SI_CUR_Name { get; set; }
        public String? SI_UnitPrice { get; set; }
        public String? SI_MaterialValue { get; set; }
        public String? SI_TotalItemIncome { get; set; }
        public String? SI_TotalHeadIncome { get; set; }
        public String? SI_TotalAmount { get; set; }
        public String? SI_ExchangeRate { get; set; }
        public String? SI_HeadGST_Amount { get; set; }
        public String? SI_ItemGST_Amount { get; set; }
        public String? SI_InvoiceAmount { get; set; }
        public String? SI_HeadWHT_Amount { get; set; }
        public String? SI_ItemWHT_Amount { get; set; }
        public String? SI_RoundOff { get; set; }
        public String? SI_BuyerReceivable { get; set; }
    }


    public class SaleInvoiceHead_DTO
    {
        ...
        public List<SaleInvoiceItem_DTO>? InvoiceItem { get; set; }
        public List<SaleInvoiceIncome_DTO>? Income { get; set; }
        public List<SaleInvoiceIIncome_DTO>? ItemIncome { get; set; }
        public List<SaleInvoiceBatch_DTO>? ItemBatch { get; set; }
        public List<SaleInvoiceAddress_DTO>? BuyerAddress { get; set; }
    ...
    public class SaleInvoiceItem_DTO
    {
    ...
    public class SaleInvoiceIncome_DTO
    {
    ...
    public class SaleInvoiceIIncome_DTO
    {
    ...
    public class SaleInvoiceBatch_DTO
    {
    ...
    public class SaleInvoiceAddress_DTO
    {
    ...
    public class SaleInvoiceAscii
    {
        public Int64 SIH_Number { get; set; }

        [Display(Name = "Sale Invoice Date")]
        public String? SIH_InvoiceDate { get; set; }

        [Display(Name = "Sale Invoice Number")]
        public String? SIH_InvoiceNo { get; set; }

        [Display(Name = "Supplier Invoice Number")]
        public String? SIH_SupplierInvoiceNo { get; set; }

        [Display(Name = "Supplier Invoice Date")]
        public String? SIH_SupplierInvoiceDate { get; set; }

        [Display(Name = "Export Order")]
        public String? SIH_ExportOrder { get; set; }

        [Display(Name = "Buyer Name")]
        public String? SIH_Buyer_Number { get; set; }

        [Display(Name = "Currency")]
        public String? SIH_Currency_Number { get; set; }

        [Display(Name = "Tax Cluster")]
        public String? SIH_TaxCluster_Number { get; set; }
        ...
        public String? SIH_TotalItem { get; set; }
    ...
    public class SaleInvoiceDetailAscii
    {
        public Int64 SIH_Number { get; set; }
        ...
        [Display(Name = "Material Segregation")]
        public String? SII_MS_Number { get; set; }

        [Display(Name = "Sale Order Number")]
        public String? SII_SIH_OrderNo { get; set; }

        [Display(Name = "Item Group")]
        public String? SII_ItemGroup { get; set; }

        [Display(Name = "Item Code")]
        public String? SII_ItemCode { get; set; }

        [Display(Name = "Description")]
        public String? SII_Description { get; set; }

        [Display(Name = "Warehouse")]
        public String? SII_Warehouse_Number { get; set; }

        [Display(Name = "UoM")]
        public String? SII_UoM { get; set; }
        ...
        [Display(Name = "Income Code")]
        public String? SIH_INC_Income { get; set; }
        ...
        [Display(Name = "HSN")]
        public String? SII_HSN_Number { get; set; }

        [Display(Name = "GST")]
        public String? SII_GST_Amount { get; set; }

        [Display(Name = "WH_Tax Code")]
        public String? SII_WHT_Code { get; set; }
    ...
    public class SaleInvoiceAddress
    {
