...
namespace ERP_DAO
{
    public class PurchaseInvoice_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet PurchaseInvoiceDB(PurchaseInvoice_DTO PI_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("PurchaseInvoice_SP");
            ...
            Db.AddInParameter(DbC, "@EXP_SAC_Number", DbType.Int64, PI_DTO.EXP_SAC_Number);
            Db.AddInParameter(DbC, "@EXP_TaxCalculate", DbType.Int64, PI_DTO.EXP_TaxCalculate);
            ...
            Db.AddInParameter(DbC, "@PII_SAC_Number", DbType.String, PI_DTO.PII_SAC_Number);
