...
namespace ERP_DAO
{
    public class SaleInvoice_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet SaleInvoiceDB(SaleInvoice_DTO SI_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("SaleInvoice_SP");
            ...
            Db.AddInParameter(DbC, "@SI_INC_Number", DbType.Int32, SI_DTO.SI_INC_Number);
