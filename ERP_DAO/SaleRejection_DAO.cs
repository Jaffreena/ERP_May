...
namespace ERP_DAO
{
    public class SaleRejection_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet SaleRejectionDB(SaleRejection_DTO SR_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("SaleRejection_SP");
            ...
            Db.AddInParameter(DbC, "@SR_INC_Number", DbType.Int32, SR_DTO.SR_INC_Number);
