...
namespace ERP_DAO
{
    public class GRNItemToPurchaseReturn_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet GRNItemToPurchaseReturnDB(GRNItemToPurchaseReturn_DTO PR_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("GRNItemToPurchaseReturn_SP");
