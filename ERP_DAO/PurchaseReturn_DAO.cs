...
namespace ERP_DAO
{
    public class PurchaseReturn_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet PurchaseReturnDB(PurchaseReturn_DTO PR_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("PurchaseReturn_SP");
            ...
            Db.AddInParameter(DbC, "@EXP_ExpenseBase", DbType.String, PR_DTO.EXP_ExpenseBase);
            Db.AddInParameter(DbC, "@EXP_ExpenseValue", DbType.String, PR_DTO.EXP_ExpenseValue);
