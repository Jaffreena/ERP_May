...
namespace ERP_DAO
{
    public class POToPurchaseInvoice_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet POToPurchaseInvoiceDB(POToPurchaseInvoice_DTO PI_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("POToPurchaseInvoice_SP");
