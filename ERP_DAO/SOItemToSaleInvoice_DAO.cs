...
namespace ERP_DAO
{
    public class SOItemToSaleInvoice_DAO
    {
        DBConnect DB = new DBConnect();
        DataSet DS = new DataSet();
        public DataSet SOItemToSaleInvoiceDB(SOItemToSaleInvoice_DTO SI_DTO)
        {
            Database Db = new SqlDatabase(DB.Connection());
            DbCommand DbC = Db.GetStoredProcCommand("SOItemToSaleInvoice_SP");
